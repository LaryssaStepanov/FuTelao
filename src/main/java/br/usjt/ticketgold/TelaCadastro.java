...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    public void cadastrar(){
        String sql = "insert into tb_pessoas (usuario, sexo, fone, email, cpf, senha, tipo) values (?, ?, ?, ?, ?, ?, ?);";
            ...
            try { 
                ...
                pst.setString(2, sexoComboBox.getSelectedItem().toString());
                pst.setString(3, telefoneTextField.getText());
                pst.setString(4, emailTextField.getText());
                pst.setString(5, cpfTextField.getText());
                pst.setString(6, senhaPasswordField.getText());
                pst.setString(7, "Comum");
    ...
    private void initComponents() {
        ...
        sexoComboBox.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        sexoComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Escolha", "Masculino", "Feminino", "Prefiro não responder" }));
        ...
        telefoneTextField.setColumns(11);
        try {
